 ...
 *
 * @package WordPress
 * @subpackage So Charmed
 * @since So Charmed 3.0
 */
...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => __( 'The homepage about widget area', 'twentyten' ),
		'before_widget' => '<p>',
		'after_widget' => '</p>',
		'before_title' => '<h2>',
		'after_title' => '</h2>',
	...
	register_sidebar( array(
		'name' => __( 'Homepage Widget Area 2', 'twentyten' ),
		'id' => 'homepage-widget-area-2',
		'description' => __( 'The homepage email sign up widget area', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h2>',
		'after_title' => '</h2>',
...
// Add a new featured image size
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'product-image', 380, 220, true ); //(cropped)
}